// PEPSIMAN AUTO-SPLITTER AND LOAD REMOVER v0.9.2 - by MrMonsh
...
startup
{
	...
	settings.SetToolTip("start_group", "Choose exactly when to start the timer.");
	...
	settings.SetToolTip("split_group_levels12", "Choose how you want to split for levels 1 and 2 of each act. Level 3 of each act will always split when you lose control of Pepsiman by default.");
